...
class TheaterViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "TheaterCell") as! TheaterCell
 ...
 */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        // Pass the movies to the MoviewDetail Controller
